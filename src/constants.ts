...
export const COMPOSER_MODEL_PREFIXES = ["grok-composer", "grok-build"] as const;
...
export const KNOWN_XAI_MODEL_LIMITS: Readonly<
...
export const SAFE_XAI_API_HOSTS = ["api.x.ai", "cli-chat-proxy.grok.com"] as const;
